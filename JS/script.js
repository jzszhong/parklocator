...
// this function takes a field name as its input, and is executed when each field is changed. It is used to hide the error messages. Penis

function CheckChange(field){
			span = document.getElementById(field + "Error");
